...
var_dump($_SESSION);
echo "</pre>";
  //$korisnik = $_GET['gKorisnik']??"Anonimus";
  $korisnik = $_SESSION['user']??"Anonimus";
  if($korisnik=="Anonimus"){
    die("Gospodine niste ulogovani ili niste nas korisnik! <a href='signup.html'>Signup</a>");// ili 404 ili signup
  }
...
<div class="col-lg-8 mx-auto p-4 py-md-5">
  ...
  <main>
    <h1>Dobrodosli <?php echo ucwords($korisnik) ?>!</h1>
